...
# --- API Key Setup (Works for both local and cloud) ---
GROQ_API_KEY = "gsk_your_actual_key_here"  # Your API key
...
try:
    ...
    st.warning(f"⚠️ AI client initialization failed: {str(e)}")
    st.info("AI insights will be disabled. You can still use all other features.")
...
def llm_analysis(df, peak_load, avg_load, load_factor, renewable_percentage, client):
    if not client:
        ...
        **To enable AI-powered insights:**
        ...
        2. Add your API key to the GROQ_API_KEY variable in the code
        3. Restart the app
